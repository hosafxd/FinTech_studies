---
title: Solving Stochastic Differential Equations
category: Stochastic Calculus & Math Foundations
topics: [SDE, geometric Brownian motion, Ornstein-Uhlenbeck, Euler-Maruyama]
source_notebook: solving_stochastic_differential_equations.ipynb
---
...
> **Category:** Stochastic Calculus & Math Foundations  
> **Topics:** SDE, geometric Brownian motion, Ornstein-Uhlenbeck, Euler-Maruyama  
> **Source notebook:** `solving_stochastic_differential_equations.ipynb`

## Description

How to actually solve common SDEs analytically (when possible) and numerically (when not). Covers GBM, OU, mean-reverting processes, and Euler-Maruyama discretization.

## When this material is useful

- Simulating asset paths under GBM or mean-reverting dynamics
- Choosing a discretization scheme (Euler-Maruyama vs Milstein) and understanding the error
- Deriving the closed-form solution for GBM and OU processes
- Plugging an SDE into a Monte Carlo pricing engine
