---
title: Is Trading Gambling? — A Quantitative Answer
category: Portfolio Management & Risk
topics: [expected value, edge, law of large numbers, skill vs luck]
source_notebook: is_trading_gambling.ipynb
---

# Is Trading Gambling? — A Quantitative Answer

> **Category:** Portfolio Management & Risk  
> **Topics:** expected value, edge, law of large numbers, skill vs luck  
> **Source notebook:** `is_trading_gambling.ipynb`

## Description

Distinguishes investing/trading from gambling using expected value, edge, and the Law of Large Numbers. Shows where the line is and why some 'trading' is mathematically indistinguishable from gambling.

## When this material is useful

- Defending a trading strategy on principled (positive-EV) grounds
- Explaining the difference between a casino, a coin flip, and a long-only equity portfolio
- Diagnosing whether a strategy has a real edge or just survivorship-biased luck
- Communicating risk to non-quants
