---
title: Brownian Motion — Simulating Random Walks in Financial Markets
category: Stochastic Calculus & Math Foundations
topics: [Brownian motion, Wiener process, random walk, diffusion]
source_notebook: brownian_motion.ipynb
---

# Brownian Motion — Simulating Random Walks in Financial Markets

> **Category:** Stochastic Calculus & Math Foundations  
> **Topics:** Brownian motion, Wiener process, random walk, diffusion  
> **Source notebook:** `brownian_motion.ipynb`

## Description

From the discrete random walk to the continuous Wiener process. Simulations illustrate the defining properties: independent Gaussian increments, continuous-but-nowhere-differentiable paths, and √t scaling.

## When this material is useful

- Generating synthetic price paths for backtests or stress tests
- Building intuition for why volatility scales with √t
- Distinguishing Brownian motion from a martingale, a random walk, and a Lévy process
- Setting up the noise term in any SDE-based model
