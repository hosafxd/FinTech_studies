---
title: How to Trade with the Kelly Criterion
category: Portfolio Management & Risk
topics: [Kelly criterion, position sizing, log-utility, geometric growth]
source_notebook: how_to_trade_with_the_kelly_criterion.ipynb
---
...
> **Category:** Portfolio Management & Risk  
> **Topics:** Kelly criterion, position sizing, log-utility, geometric growth  
> **Source notebook:** `how_to_trade_with_the_kelly_criterion.ipynb`

## Description

Optimal bet sizing via the Kelly criterion. Derives the formula for both discrete bets and continuous trading, explains why Kelly maximizes long-run growth, and warns about the dangers of full Kelly under uncertainty.

## When this material is useful

- Sizing positions to maximize geometric growth (not arithmetic mean)
- Computing fractional Kelly when edge is uncertain
- Choosing leverage in a trading strategy
- Explaining why over-sizing (super-Kelly) is mathematically guaranteed to ruin you
...
- Title: Trading System Analysis: Kelly Criterion vs Non-Ergodic Systems
- X axis: Trades
- Y axis: Capital ($)
- Traces (202):
  - `trace0` (scatter)
...
**Interactive Plotly chart** (rendered live in the notebook).
- Title: Trading System Analysis: Small vs Large Fixed Bet Size
- X axis: P/L
- Y axis: Frequency
- Traces (204):
  - `Losses` (histogram)
...
```
After 1000 trades:
Small Bet System Average Value: $4872.54
Large Bet System Average Value: $12617.61
```
...
**Interactive Plotly chart** (rendered live in the notebook).
- Title: Trading System Analysis: Ergodic vs Non-Ergodic Systems
- X axis: Trades
- Y axis: Capital ($)
- Traces (202):
  - `trace0` (scatter)
...
```
Mean final wealth after 1000 trades:
Ergodic strategy: $9,432.50
Non-ergodic strategy: $1,757.07
```
...
```
Probability of ending above $1,000 after 1000 trades:
Ergodic strategy: 74.0%
Non-ergodic strategy: 47.0%
```
...
Probability of ending above initial capital: 76.0%
Probability of ending below initial capital: 24.0%

Non-Ergodic System:
Probability of ending above initial capital: 43.0%
Probability of ending below initial capital: 57.0%

Median final wealth:
Kelly Criterion: $1018.67
Non-Ergodic: $836.63
```
...
**Interactive Plotly chart** (rendered live in the notebook).
- Title: Evolution of Trading Parameters Over Time
- X axis: Time
- Y axis: Probability
- Traces (4):
  - `Probability of Winning` (scatter)
  - `Probability of Losing` (scatter)
  - `Average Winning Trade` (scatter)
  - `Average Losing Trade` (scatter)
...
**Interactive Plotly chart** (rendered live in the notebook).
- Title: Impact of Kelly Criterion Estimation Error
- X axis: Trades
- Y axis: Capital ($)
- Traces (202):
  - `trace0` (scatter)
...
Final Wealth Statistics:
Correct Estimation - Median Final Wealth: $1161.84
Incorrect Estimation - Median Final Wealth: $778.23

Probability of Ending Above Initial Capital:
Correct Estimation: 71.0%
Incorrect Estimation: 41.0%
```
