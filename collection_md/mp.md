---
title: The Markov Property — Are Stock Prices Memoryless?
category: Stochastic Calculus & Math Foundations
topics: [Markov property, memorylessness, weak EMH, autocorrelation]
source_notebook: mp.ipynb
---

# The Markov Property — Are Stock Prices Memoryless?

> **Category:** Stochastic Calculus & Math Foundations  
> **Topics:** Markov property, memorylessness, weak EMH, autocorrelation  
> **Source notebook:** `mp.ipynb`

## Description

Stress-tests the assumption that future prices depend only on the present state, not the path that got there. Empirical tests of autocorrelation, runs, and conditional distributions on real return data.

## When this material is useful

- Deciding whether to use a Markovian model (GBM) or one with memory (fractional Brownian)
- Explaining the weak form of the Efficient Market Hypothesis
- Diagnosing serial correlation in returns
- Justifying or rejecting models that ignore the price history
